...
<section id="patient_details" class="page-section color">
  <div class="container">
    <div class="heading text-center"> 
      <!-- Heading -->
      <h6>details_about_bee_stings table</h6>
    </div>
...
<div class="panel panel-default">
  <div class="panel-heading clearfix"> 
        ...
        <b>Patient Details about bee_stings</b>
...
<section id="patient_details" class="page-section color">
  <div class="container">
    <div class="heading text-center"> 
      <!-- Heading -->
      <h6>details_about_black_widow_spider</h6>
    </div>
<?php
...
<div class="panel panel-default">
  <div class="panel-heading clearfix"> 
        <span class="glyphicon glyphicon-th"></span> 
        <b>Patient details about black_widow_spider</b>
        <!--<div class="pull-right">
          <form method="POST" action="doctor_hp.php">
          <button type="submit" class="btn btn-success" name="name_search" value="Search">
             <span class="glyphicon glyphicon-circle-arrow-left"></span>
...
<section id="patient_details" class="page-section color">
  <div class="container">
    <div class="heading text-center"> 
      <!-- Heading -->
      <h6>details_about_hornet_stings</h6>
    </div>
<?php
...
<div class="panel panel-default">
  <div class="panel-heading clearfix"> 
        <span class="glyphicon glyphicon-th"></span> 
        <b>Patient details_about_hornet_stings</b>
        <!--<div class="pull-right">
          <form method="POST" action="doctor_hp.php">
          <button type="submit" class="btn btn-success" name="name_search" value="Search">
             <span class="glyphicon glyphicon-circle-arrow-left"></span>
...
<section id="patient_details" class="page-section color">
  <div class="container">
    <div class="heading text-center"> 
      <!-- Heading -->
      <h6>details_about_wasp_stings</h6>
    </div>
<?php
...
<div class="panel panel-default">
  <div class="panel-heading clearfix"> 
        <span class="glyphicon glyphicon-th"></span> 
        <b>Patient details_about_wasp_stings</b>
        <!--<div class="pull-right">
          <form method="POST" action="doctor_hp.php">
          <button type="submit" class="btn btn-success" name="name_search" value="Search">
             <span class="glyphicon glyphicon-circle-arrow-left"></span>
